...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<div class="form-group has-warning">
				...
				<input type="text" class="form-control" name="username" id="username" placeholder="<?php _e( 'Username or email', 'woocommerce' ); ?>" value="<?php if ( ! empty( $_POST['username'] ) ) echo esc_attr( $_POST['username'] ); ?>" />
			</div>
