...
$block_class = "col-lg-3 col-md-3 col-sm-4 col-xs-12 product-block";
if(isset($woocommerce_loop['related_type']) && $woocommerce_loop['related_type'] == "mobile"){
    $block_class = "product-block";
}
?>
...
<div class="<?php echo $block_class ?>">
    <div class="product">
        <a href="<?php the_permalink(); ?>" class="image-block">
            ...
            <?php the_post_thumbnail(apply_filters( 'single_product_large_thumbnail_size', 'shop_catalog' ), array('class' => 'visible-xs small-image')); ?>
        </a>
