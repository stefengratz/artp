...
<div class="rating-review-wrapper clearfix">
    <div class="rating pull-left">
        <?php echo ap_get_rating_star_html(get_post_meta(get_the_ID(), 'difficulty', true)); ?>
    </div>

    <ul class="list-inline review pull-left">
        <li><a href="#fb-comments-wrapper" data-scroll-top="true">Viết bình luận</a></li>
    </ul>
    <div class="pull-right hidden-sm">
    	<div class="fb-like" data-href="<?php the_permalink(); ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
    </div>
</div>
<div class="clearfix visible-sm single-product-social-sm">
	<div class="">
    	<div class="fb-like" data-href="<?php the_permalink(); ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
    </div>
</div>
